#read cvs
mydata<-read.csv("/Users/andreabrianc/Desktop/machine learning/Bank-full Dataset.csv" ,sep = ";")
...
nrow(traindata)
str(traindata)
barplot(table(traindata$yvar))
testdata<-datamixed[30235:43193, ]
str(testdata)
nrow(testdata)
barplot(table(testdata$yvar))
...
#chopping the 1st 18655 data with "No" data:
